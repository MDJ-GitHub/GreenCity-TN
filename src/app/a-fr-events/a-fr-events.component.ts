...
export class AFrEventsComponent implements OnInit {
  ...
  getInfo() {
      ...
      this.http.get("https://greencitytemp-default-rtdb.europe-west1.firebasedatabase.app/events/" + loc + "/.json", httpOptions).subscribe(responseData => {
        ...
        if (responseData != null) {
          ...
          Object.entries(responseData).map(a => {
            console.log(a[1])
            // @ts-ignore
            document.getElementById("events").insertAdjacentHTML('afterbegin', ' <div id="' + a[0] + 'div" class="card text-white bg-secondary mb-3">    <div class="card-body">      <h5 class="card-title"> ' + a[1].title + ' &nbsp;           <img src="/assets/img/calendar.png" width="20" height="20" style=" float: center;" alt=""> ' + a[1].date + ' &nbsp;           <img src="/assets/img/flag-fill.png" width="20" height="20" style=" float: center;" alt=""> ' + a[1].date_en + ' &nbsp;           <img src="/assets/img/map.png" width="20" height="20" style=" float: center;" alt=""> ' + a[1].location + ' &nbsp;           <img src="/assets/img/plus.png" width="20" height="20" style=" float: center;" alt=""> ' + a[1].mun + ' <img  id="' + a[0] + 'remove" (click)="remove(' + "'" + a[0] + "'" + ')" src="/assets/img/remove.png" width="20" height="20" style="float: right;" alt="">     <img src="/assets/img/empty.png" width="10" height="10" style="float: right;" alt="">        <img id="' + a[0] + 'modify" (click)="modifyn(' + "'" + a[0] + "'" + ')" src="/assets/img/modify.png" width="20" height="20" style="float: right;" alt="">        <img src="/assets/img/empty.png" width="10" height="10" style="float: right;" alt="">     </h5> &nbsp;      <p class="card-text">' + a[1].subject + '</p>      <p class="card-text bg-dark">' + a[1].description + '</p>      <hr>      <img src="' + a[1].picture1 + '" width="150" height="125">      <img src="' + a[1].picture2 + '" width="150" height="125">      <img src="' + a[1].picture3 + '" width="150" height="125">      <img src="' + a[1].picture4 + '" width="150" height="125">      <img src="' + a[1].picture5 + '" width="150" height="125">    </div>  </div>');
    ...
    remove(str) {
      ...
      x = x.replace('remove', '');
      this.http.delete("https://greencitytemp-default-rtdb.europe-west1.firebasedatabase.app/events/" + loc + "/" + x + ".json", httpOptions).subscribe(responseData => {
        this.refresh();
    ...
    send() {
      ...
      const object = {
        ...
        mun: (document.getElementById("idmunx") as HTMLFormElement)['value'],
      ...
      this.http.post("https://greencitytemp-default-rtdb.europe-west1.firebasedatabase.app/events/" + loc + ".json", object, httpOptions).subscribe(responseDataa => {
        alert("L'événement a été annoncé avec succès !")
